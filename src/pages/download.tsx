  ...
  <IndexLayout>
    <Page>
      <Container>
        ...
        <p>
        If you'd like to host a server without running an instance of Super Mario 64 you can download the server executable from <a href='https://github.com/Tarnadas/net64plus-server'>here</a>.
        </p>
      </Container>
    </Page>
  </IndexLayout>
